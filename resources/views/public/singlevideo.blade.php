    ...
    <div class="uk-container uk-container-center">
        <div id="tm-middle" class="tm-middle uk-grid" data-uk-grid-match="" data-uk-grid-margin="">
                ...
                <main id="tm-content" class="tm-content">
                    <div class="contentpaneopen">
                        <article>
                            ...
                            <div class="article-slider" style="    border-radius: 18px;
                            overflow: hidden;">
                                ...
                                <div class="yashare-auto-init" data-yasharel10n="en" data-yasharetype="none"
                                    data-yasharequickservices="facebook,twitter,gplus"><span class="b-share"><a
                                            ...
                                            data-service="facebook"><span
                                                class="b-share-icon b-share-icon_facebook"></span></a><a rel="nofollow"
                                            ...
                                            data-service="twitter"><span
                                                class="b-share-icon b-share-icon_twitter"></span></a><a rel="nofollow"
                                ...
                                @if (1)
                                    @if ($xx <= 2)
                                        <div
                                            ...
                                            <div class="wrapper">
                                                <div class="img-wrap">
                                                    <a href="{{ url('/videos/' . $singlevideo->id . '/show') }}">
            ...
            <aside class="tm-sidebar-a uk-width-medium-1-4 uk-pull-3-4 uk-row-first pt-5">
                ...
                flex-wrap: wrap;" class="uk-panel news-sidebar" style="display:flex; flex-wrap: wrap">
                ...
                <div style="direction: rtl ;" class="uk-panel tags-sidebar pt-4">
                    ...
                    <div class="contentpaneopen">
                        <ul id="tag-list-mod-tagcloud" class="tag_list" style="display: flex;list-style-type: none;">
                            @foreach ($videoTAGS as $tagvideo)

                            <li class="tag_element" id="tag-0"><a href="/tags/{{$tagvideo->id}}/show" rel="nofollow"><span
                                        class="tag">{{$tagvideo->TITLE}}</span></a></li>
                                        @endforeach
