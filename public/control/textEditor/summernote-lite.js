...
(function (global, factory) {
  ...
  var editable = renderer.create('<div class="note-editable" id="editor1" style="min-height: 539.406px;" contentEditable="true" role="textbox" aria-multiline="true"/>');
  ...
  var airEditable = renderer.create([
      '<div class="note-editable" id="editor1" contentEditable="true" role="textbox" aria-multiline="true"/>',
      '<output class="note-status-output" role="status" aria-live="polite"/>',
  ].join(''));
